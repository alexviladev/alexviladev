...
<code style="display:flex"><a style="margin-right:17px; margin-bottom: 17px; width:60px; height:60px;
...
<a style="display:flex; align-items:center; padding-left:5px; padding-right: 5px; margin-bottom: 17px; margin-right:17px; height:60px;
 ...
 <code style="display:flex" ><a style="display:flex; align-items:center; padding-left:5px; padding-right: 5px; margin-bottom: 17px; margin-right:17px; height:60px;
  ...
  <a style="display:flex; align-items:center; padding-left:5px; padding-right: 5px; margin-bottom: 17px; margin-right:17px; height:60px;
  background: white; 
  box-shadow: -7px 7px 0 black;" target="_blank" rel="noopener noreferrer" href="https://nodejs.org/api/"><img alt="Node.js" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fpluspng.com%2Fimg-png%2Fnodejs-png--400.png&f=1&nofb=1"></a></div></code>
